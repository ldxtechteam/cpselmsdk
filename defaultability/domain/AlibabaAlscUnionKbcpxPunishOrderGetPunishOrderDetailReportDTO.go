...
type AlibabaAlscUnionKbcpxPunishOrderGetPunishOrderDetailReportDTO struct {
    ...
    /*
        处罚结算时间     */
    ReturnCommissionTime  *string `json:"return_commission_time,omitempty" `
...
func (s *AlibabaAlscUnionKbcpxPunishOrderGetPunishOrderDetailReportDTO) SetBizOrderId(v string) *AlibabaAlscUnionKbcpxPunishOrderGetPunishOrderDetailReportDTO {
    s.BizOrderId = &v
    return s
}
func (s *AlibabaAlscUnionKbcpxPunishOrderGetPunishOrderDetailReportDTO) SetExtInfo(v string) *AlibabaAlscUnionKbcpxPunishOrderGetPunishOrderDetailReportDTO {
    s.ExtInfo = &v
    return s
}
func (s *AlibabaAlscUnionKbcpxPunishOrderGetPunishOrderDetailReportDTO) SetReturnCommissionTime(v string) *AlibabaAlscUnionKbcpxPunishOrderGetPunishOrderDetailReportDTO {
    s.ReturnCommissionTime = &v
    return s
}
