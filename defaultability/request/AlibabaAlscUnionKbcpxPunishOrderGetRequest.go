...
type AlibabaAlscUnionKbcpxPunishOrderGetRequest struct {
    /*
        时间维度，1.订单结算时间 2.维权创建时间 3.维权完成时间 4更新时间;5处罚结算时间 defalutValue��1    */
...
func (s *AlibabaAlscUnionKbcpxPunishOrderGetRequest) SetFlowType(v string) *AlibabaAlscUnionKbcpxPunishOrderGetRequest {
    s.FlowType = &v
    return s
}
